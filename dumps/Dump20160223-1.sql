...
INSERT INTO `ADDRESS` VALUES (1,'1',4),(2,'2',8),(3,'2',3),(4,'18',4),(5,'18',1),(6,'1',1),(7,'3',1),(8,'25',6),(9,'133',5),(10,'25',4),(11,'128',5);
...
INSERT INTO `FRIEND` VALUES (5,6,54,NULL),(6,5,55,NULL);
...
INSERT INTO `IMAGE` VALUES (1,'?¼b—O·úPÂ\"ˆoÁ…ù8à©½š–,ŒãiÜÅƒ®®','/restaurant/images/[B@a0ce348','IMAG0771.jpg');
...
INSERT INTO `RESERVATION` VALUES (1,'2016-02-26 16:20:00',2,-1,'reservation0',3,NULL,5);
...
CREATE TABLE `RESTAURANT` (
  ...
  `REST_GRADE` double DEFAULT NULL,
...
INSERT INTO `RESTAURANT` VALUES (1,-1,'Kod mise',3,2,2),(3,-1,'Za konfiguraciju',11,2,8);
...
INSERT INTO `TABLES_CONFIGURATION` VALUES (1,'','2016-02-19 00:00:00',NULL,'Konfiguracija 1',7,7,1,4),(2,'','2016-02-22 00:00:00',NULL,'Moja konfiguracija',6,6,3,8);
...
INSERT INTO `USER` VALUES (1,'LOCAL','','marko_jovanovic@gmail.com','\0','Marko','kpLîù ®×Ñ¡ÍL{	jÊ‘¾\r›’CÏ‡æ‚','iLTŠpCcg\"ÍXÍ‹‡ß','','Jovanovic',NULL,NULL,NULL,NULL,NULL,1,NULL),(2,'LOCAL','','mihailo931@gmail.com','','Mihailo','†ºxÁuêß$òZ®o…¶ÉÊğ‚&Ü |˜s¸¤~\nX','`1ô¬èE>Úden!m','6031077BBBC73B84EAFB233B689C9B16','Vasiljevic',NULL,NULL,NULL,NULL,NULL,1,NULL),(3,'LOCAL','','petar@petar.com','\0','Petar','.YaOVáı³DpŒî·ìÂS@A¶íRÏİŸÈ—ÕÉG','éZ’Èdyœ}œÔV\"¯õ°[','','Peric','40ñ» i\'Ó]“¥UüPbÏı’¹ª|‘ë‚F˜ë',1,NULL,NULL,2,3,NULL),(4,'LOCAL','','stefan@stefan.com','','Stefan','4€¬lòËà¯ßEô¸’^Ô<†>•«Zí‚–«ì¢³\'J','™#gF——^nß=(ÛKªî','6786102582D1C5DDC39C5131DBD0A530','Stefic','JëàfJ”Z-5YBæ`<‰Ğ‚¬9@4¡¾r€Kû¥',1,NULL,NULL,2,3,NULL),(5,'LOCAL','','stefan_stephen@gmail.com','','Stefan','øäÌA{¬!IÄÜ¶Š,ä­OA,E$ì¤ş,¥ÿ','jù¡qFâ¢\n•Šç«I','21C254779BAFA0E63012AECA03486E23','Stefanovic',NULL,NULL,9,NULL,NULL,2,NULL),(6,'LOCAL','','mihailo93@gmail.com','\0','Mirko','”â-aŒùá‰ÌE§çoOÙß{^æ3şºÿtzV‹Ã','z§~?„C÷Xü‘D','730A80832C45E3B0877534B87A5C2F3E','Maric',NULL,NULL,NULL,NULL,NULL,2,NULL),(7,'LOCAL','','mihailo.vasiljevic93@gmail.com','\0','Sanja','îb@™ß]+‡:Ê¤g‚´–9œO\Z‰¿æVz,','è¦™2Yà‹Ò ŞÏs²Ã','D7372AEECFA38141E0CD83EC1810C935','Popovic',NULL,NULL,NULL,NULL,NULL,2,NULL),(8,'LOCAL','','menadzer@menadzer.com','','menadzer',',™QM´İ›æ 7†¸¬w+éèM–d4v‚hoÔ¨×','v‘OUIÜâøüçâè','0959D162EA6AE28963A2F131038B2B72','menadzer','Í¤–ÏJşogÉè\\ªPÛ(VÊ÷Ù9¡ğÕ±NØ+I',3,NULL,1,2,3,NULL);
...
-- Dump completed on 2016-02-23 20:19:21
