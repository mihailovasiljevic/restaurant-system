...
public class ReservationPartOneController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		if (req.getSession().getAttribute("user") == null) {
			...
			makeReservationPartOne(req, resp); //synchronized method
		}
	}
	...
	private synchronized void makeReservationPartOne(HttpServletRequest req, HttpServletResponse resp) throws JsonGenerationException, JsonMappingException, IOException{
		try {
