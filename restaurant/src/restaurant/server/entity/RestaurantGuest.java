...
public class RestaurantGuest implements Serializable{
	...
	@Column(name = "REST_GUEST_SALT", nullable = false, length = 256)
	private byte[] salt;
	...
	public RestaurantGuest(String name, String surname, String email, byte[] password, Boolean activated,
						   Integer numberOfVisits, Address address, Restaurant restaurant, Image image, UserType userType,
						   Set<Friend> myFriends, Set<Invitation> sentInvitations, Set<Invitation> receivedInvitations,
						   Set<Reservation> reservations, byte[] salt) {
		super();
		this.name = name;
		this.surname = surname;
		this.email = email;
