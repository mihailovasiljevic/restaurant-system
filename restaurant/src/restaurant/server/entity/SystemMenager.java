...
public class SystemMenager implements Serializable{
	...
	@Column(name = "SYS_MEN_SALT", nullable = false, length = 256)
	private byte[] salt;
	...
	public SystemMenager(String name, String surname, String email, byte[] password, Address address, Image image,
						 UserType userType, Set<Restaurant> restaurants, Set<RestaurantType> restaurantTypes,
						 Set<RestaurantMenager> restaurantMenagers, byte[] salt) {
		super();
		this.name = name;
		this.surname = surname;
		this.email = email;
	...
	public String toString() {
		return "SystemMenager [id=" + id + ", name=" + name + ", surname=" + surname + ", email=" + email
				+ ", password=" + password + "]";
	}
