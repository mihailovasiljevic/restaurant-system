                        ...
                        var allGood = false;
                            ...
                            if(allGood == true){
                                ...
                                $.ajax({
                                      ...
                                      success: function (data, status) {
                                        if(data == "USPEH"){
                                             window.location.href = "/restaurant/guest/friends.jsp";
                                             $('#btn-updateType').hide();
                                             $('#btn-type').show();
                                             return;
                                        }else{
		...
		<div class="col-md-9">
            <div class="profile-content" id="content">
                 ...
                 <div class="container">
                          ...
                          <div class="table-responsive">
                            <table class="table table-hover">
                              ...
                              <tbody id="restaurantTable">
                                <c:forEach var="i" items="${sessionScope.user.myFriends}">
                                    <tr>
                                        ...
                                        <td><a href="#" data-href="../api/guest/deleteFriend?userId=${i.id}&page=friends" data-toggle="modal" data-target="#confirm-delete">Ukloni iz liste prijatelja</a></td>
                   ...
                   <div class="container">
                        <div class="row">
                            <b><span class="col-md-8 control-label">Nemate prijatelja. Iskoristite formu ispod da ih pronadjete i dodate.<br /><br /><br /><br /><br /></span></b>
                                    ...
                                    <tr>
                                        ...
                                        <c:if test="${fn:length(sessionScope.user.myFriends) > 0}">
                                            <c:forEach var="j" items="${sessionScope.user.myFriends}">
                                                <c:if test="${j.id != i.id}">
                                                    <td><a href="../api/guest/addFriend?userId=${i.id}&page=friends">Dodaj</a></td>    
                                                </c:if>
                                                <c:if test="${j.id == i.id}">
                                                    <td><a href="#" data-href="../api/guest/deleteFriend?userId=${i.id}&page=friends" data-toggle="modal" data-target="#confirm-delete">Ukloni iz liste prijatelja</a></td>
                                                </c:if>
