    ...
    <section id="restaurants" class="about">
		...
		<div class="col-md-9">
            <div class="profile-content" id="content">
                ...
                <c:if test="${sessionScope.reservationForDecision != null}">  
                 <div class="container">
                    <div class="row">
                        <h3>Restoran: ${sessionScope.reservationForDecision.restaurant.name}</h3>    
                        <h3>Datum i vreme: ${sessionScope.reservationForDecision.date}</h3> 
                        <h3>Trajanje: ${sessionScope.reservationForDecision.forHowLong} sata</h3> 
                        <h3> Pozvani su jos i :
                            <c:forEach var="i" items="${sessionScope.reservationForDecision.invitations}">
                                ${i.userGuestInvitationReceived.name}, 
                            </c:forEach>
                        </h3>
                    </div>
                </div>
