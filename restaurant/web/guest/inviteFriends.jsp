            ...
            <div class="profile-content" id="content">
                 ...
                 <div class="container">
                    <div class="row">
                        ...
                        <p><h3>Odabrani stolovi:
                        <c:forEach var="i" items="${sessionScope.reservationInProgress.listOfTables}">
                            <b>${i.name}</b><br />
                        </c:forEach>
                        </h3></p>
                     	<p><h2>Pozovite prijatelje: </h2></p>
                              ...
                              <tbody id="restaurantTable">
                                <c:forEach var="i" items="${sessionScope.user.myFriends}">
                                    <tr>
                                        ...
                                        <td><label><input type="checkbox" value="${i.id}"></label></td>
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    <!-- Button -->                                        
                                    <div class="col-md-offset-3 col-md-9">
                                        <button id="btn-choose" type="button" class="btn btn-info"><i class="icon-hand-right"></i>Posalji pozivnice i potvrdi rezervaciju</button>                        
                                    </div>
                                </div>  
