...
public class RestaurantMenager implements Serializable{
	...
	public RestaurantMenager(Integer id, String name, String surname, String email, String password, Address address,
			Image image, SystemMenager systemMenager, Set<TablesConfiguration> tablesConfigurations, Set<Menu> menus) {
		super();
		this.id = id;
		this.name = name;
		this.surname = surname;
